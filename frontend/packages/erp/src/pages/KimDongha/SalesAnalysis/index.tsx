...
import {
  getDonghaSalesOverview,
  getDonghaSalesRevenue,
  getDonghaSalesFtNew,
  getDonghaSalesPtTrial,
  getDonghaSalesRereg,
...
export default function SalesAnalysis() {
  ...
  const fetchData = useCallback(async (m: string, d?: string) => {
    ...
    try {
      const [ovRes, revRes, ftRes, ptRes, reregRes, subRes] = await Promise.all([
        getDonghaSalesOverview(m, d),
        getDonghaSalesRevenue(m, d),
        getDonghaSalesFtNew(m, d),
        getDonghaSalesPtTrial(m, d),
        getDonghaSalesRereg(m, d),
        getDonghaSalesSubscription(m, d),
      ]);
  ...
  useEffect(() => {
    getDonghaSalesAvailableDates(month).then((res) => {
